...
*𝑲𝒍𝒊𝒌 𝒕𝒐𝒎𝒃𝒐𝒍 𝒅𝒊𝒃𝒂𝒘𝒂𝒉 𝒋𝒊𝒌𝒂 𝒂𝒏𝒅𝒂 𝒔𝒆𝒕𝒖𝒋𝒖 𝒅𝒆𝒏𝒈𝒂𝒏 𝐒 & 𝐊 𝐖𝐚𝐧𝐧𝐁𝐨𝐭𝐳-𝐌𝐃*,
`
conn.sendButtonDoc(m.chat, wan, botdate,'⫷ sᴇᴛᴜᴊᴜ ⫸','.setuju', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
