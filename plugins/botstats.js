...
conn.sendButtonDoc(m.chat, '▷ʙᴏᴛ sᴛᴀᴛᴜs◁', sts, '⫷ ᴏᴡɴᴇʀ ⫸', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
    mediaUrl: 'https//wa.me/6281265970249?text=ʜᴀʟᴏ+ᴏᴡɴᴇʀ',
    mediaType: 2, 
    description: 'wa.me/6281265970249?text=ʜᴀʟᴏ+ᴏᴡɴᴇʀ',
